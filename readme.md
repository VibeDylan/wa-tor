...
`py -3.12 -m venv .venv`
3. Execute this command to allow scripts execution in PowerShell `Set-ExecutionPolicy Unrestricted -Scope Process`
4. Activate the environment : `.\.venv\Scripts\Activate`
5. Check the Python version : `python --version`